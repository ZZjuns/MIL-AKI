...
class WebTrafficDataset(MILTSCDataset):
    ...
    def __init__(self, args, split: str, dataset_name: str = "WebTraffic", apply_transform: bool = True):
        super().__init__(args, dataset_name, split, apply_transform=apply_transform)
