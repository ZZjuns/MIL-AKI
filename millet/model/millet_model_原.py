...
class MILLETModel:
    ...
    def fit(
        ...
        for index in range(n_epochs):
            ...
            print("Training model:{}/{}epoch--------epoch loss-------loss:{},acc:{},bal_acc:{},auroc:{}".format(index+1,n_epochs,epoch_train_results['loss'],epoch_train_results['acc'],epoch_train_results['bal_acc'],epoch_train_results['auroc']))
